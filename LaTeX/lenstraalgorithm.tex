...
\end{table}
\Cref{unsuccessfuldouble} shows the points generated by doubling, and \cref{unsuccessfuladd} shows the additions being performed.
\begin{table}[htbp]
	\centering
	\begin{tabular}{c}
...
\end{table}
\Cref{successfuldouble} again shows the list of points generated by doubling $P$, which is successful. However, when adding points to find $kP$, we can only get so far, as...
\begin{table}[htbp]
	\centering
	\begin{tabular}{c}
