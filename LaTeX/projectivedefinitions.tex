...
\begin{definition}
	A singular point on a curve $f$ is a point where both partial derivatives $f_x$ and $f_y$ vanish. A point that is not a singular point is called a regular point.
\end{definition}
